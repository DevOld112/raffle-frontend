...
<template>
    ...
    <section class="py-16 pt-18">
        <div class="w-4/5 md:w-3/5 mx-auto">
            ...
            <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">Aquí encontrarás respuestas a las preguntas más comunes sobre nuestra plataforma de rifas. Si tienes alguna otra pregunta o necesitas más información, no dudes en contactarnos por correo electrónico.</p>
        </div>
